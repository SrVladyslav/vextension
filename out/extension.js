...
const printChecker_1 = require("./printChecker"); // Importa la función desde el archivo printChecker
...
function activate(context) {
    ...
    const disposable = vscode.commands.registerCommand('vextension.checkprints', () => {
        (0, printChecker_1.checkPrintsInStagedFiles)(); // Llama a la función que verificará los prints en los archivos modificados
    });
